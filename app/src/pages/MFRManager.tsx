                                ...
                                <tr key={mfr.id} className="hover:bg-slate-50 transition-colors cursor-pointer" onClick={() => setSelectedMFR(mfr)}>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex justify-end gap-1">
                                            <Button size="icon" variant="ghost" title="Issue New BMR" className="text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50" onClick={(e) => { e.stopPropagation(); toast.info('Navigating to BMR Issuance...'); }}><Plus className="h-4 w-4" /></Button>
                        ...
                        <div className="col-span-2 space-y-4 mt-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <Button variant="outline" size="sm" onClick={() => {
                                    setFormData({
                                        ...formData,
                                        processSteps: [...(formData.processSteps || []), { stepNumber: (formData.processSteps?.length || 0) + 1, phase: 'Manufacturing', department: '', description: '', criticalParameters: [], roleRequired: 'Operator' }]
                                    });
