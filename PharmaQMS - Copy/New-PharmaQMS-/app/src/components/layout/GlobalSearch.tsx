...
export function GlobalSearch() {
    ...
    const safeNavigate = (path: string, options?: { state?: any }) => {
        const currentState = location.state;
        const nextState = options?.state;

        if (location.pathname === path && JSON.stringify(currentState) === JSON.stringify(nextState)) {
            return;
        }
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        setOpen(false);
                                        safeNavigate('/batch-trace', { state: { batchNumber: product.batchNumber } });
                                    }}
                                >
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        setOpen(false);
                                        safeNavigate('/batch-trace', { state: { batchNumber: material.batchNumber } });
                                    }}
                                >
                                    <History className="h-3 w-3 mr-1" /> Trace
                                </Button>
